...
const Rclass = () => {
  ...
  const exportToExcel = () => {
    ...
    utils.book_append_sheet(wb, ws, "Class Enrollment Report");
    writeFile(wb, "Class_Enrollment_Report.xlsx");
  };
  const handleSubmit = async () => {
    ...
    try {
      ...
      const response = await axios.get(
        `${apiUrl}api/classenrollment/getClassEnrollmentByCriteria`,
        {
          params: {
  ...
  const getClassEnrollmentAll = async () => {
    try {
      const response = await axios.get(
                  ...
                  <div className="py-3 sm:py-5 sm:grid sm:grid-cols-6 sm:gap-6 sm:px-6">
                    ...
                    <dd className="mt-1 text-sm text-gray-900 sm:mt-0 sm:col-span-2">
                      ...
                      >
                        ...
                        <option value="true">Disactive</option>
                      </select>
                    </dd>
                  </div>
                  <div className="py-3 sm:py-5 sm:grid sm:grid-cols-6 sm:gap-6 sm:px-6">
          ...
          <>
            <div className="p-8" id="report">
              ...
              <div className="flex justify-center items-center">
                <h1 className="text-2xl font-bold">Class Enrollment Report</h1>
              </div>
              <div className="flex justify-center items-center mb-6">
              ...
              <table className="min-w-full table-auto border border-gray-300">
                ...
                <tbody>
                  {classEnrollment.map((user, index) => (
